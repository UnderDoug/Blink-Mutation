...
namespace XRL.World.Parts
{
        ...
        , IModEventHandler<AfterBlinkEvent>
    {
        ...
        public static bool CanFlicker(GameObject Flickerer, string Verb = "flicker", bool Silent = false)
        {
                ...
                while (FlickerCharges > 0 && attempts < maxAttempts && !flickerTargets.IsNullOrEmpty())
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            flickerTargets.Remove(FlickerTargetOverride);
                            FlickerTargetOverride = null;
                            Flickerer.Target = null;
        ...
        public static void CNS_TestKit_WishHandler(string Parameters)
        {
            ...
            List<(string blueprint, int count, List<string> mods)> speedyItems = new()
            {
                ...
                ("Antimatter Cell", 12, new(){ nameof(ModRadioPowered), nameof(ModHighCapacity), }),
                ...
                ("Battle Axe8", 3, new(){ nameof(ModSerrated), nameof(ModCounterweighted), nameof(ModSharp), }),
